...
class Music:
    ...
    @commands.command(name='summon', aliases=['connect', 'join', 'move'])
    ...
    @commands.command(name='stop', aliases=["disconnect", "leave", "unsummon"])
    async def stop_player(self, ctx):
        ...
        delete_contents("E:\\PycharmProjects\\Ralsei-Rewritten\\downloads")
    ...
    @commands.command(name='nowplaying', aliases=['currentsong', 'current', 'np'])
